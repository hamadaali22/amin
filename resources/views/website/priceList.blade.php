                            ...
                            <div class="filter-bar">
                                ...
                                <div class="form-title-wrap2">
                                    <div class="row pr-3">
                                        ...
                                        <div class="col-lg-3 col-sm-3 progress_car"> <svg xmlns="http://www.w3.org/2000/svg"
                                                width="57.917" height="24.126" viewBox="0 0 57.917 24.126">
                                                <g id="_4047289_auto_car_compact_automible_icon_1_"
                                                    data-name="4047289_auto_car_compact_automible_icon (1)"
                                                    transform="translate(-1276.232 366.065)">
                                                    <path id="Path_57" data-name="Path 57"
                                                        ...
                                                        <div class="checkbox-wrap">
                                                            <div class="custom-checkbox">
                                                                ...
                                                                <label for="r1">
                                                                    <span class="ratings d-flex align-items-center">
                                                                        <span class="color-text-3 font-size-13 ml-1">شركة
                                                                            اكسا للتامين التعاوني</span>
                                                                    </span>
                                                                </label>
                                                            </div>
                                                            <div class="custom-checkbox">
                                                                ...
                                                                <label for="r2">
                                                                    <span class="ratings d-flex align-items-center">
                                                                        <span class="color-text-3 font-size-13 ml-1">الدرع
                                                                            العربي للتأمين</span>
                                                                    </span>
                                                                </label>
                                                            </div>
                                                            <div class="custom-checkbox">
                                                                ...
                                                                <label for="r3">
                                                                    <span class="ratings d-flex align-items-center">
                                                                        <span class="color-text-3 font-size-13 ml-1">شركة
                                                                            التعاونية للتأمين التعاوني - سند بلس</span>
                                                                    </span>
                                                                </label>
                                                            </div>
                                                            <div class="custom-checkbox">
                                                            ...
                                                            <div class="custom-checkbox">
                                                                ...
                                                                <label for="r5">
                                                                    <span class="ratings d-flex align-items-center">
                                                                        ...
                                                                        <span class="color-text-3 font-size-13 ml-1">شركة
                                                                            التعاونية للتأمين التعاوني</span>
                                                                    </span>
                                                                </label>
                                                            </div>
                                                        </div>
                            ...
                            <div class="pt-3 collapse" id="collapseTwo">
                                <div class="slider-range-wrap text-left ">
                                    <div class="price-slider-amount padding-bottom-20px">
                                        <label for="amount" class="filter__label">معلومات مالك الوثيقة و المركبة
                                        </label> <br>
                            ...
                            <div class="quote-top-row col-sm-12" style="     height: 60px;">
                                <div class="row col-sm-12">
                                    ...
                                    <div class="col-lg-2 col-sm-4">
                                        ...
                                        <div class="najmrating" data-toggle="tooltip" data-html="true"
                                            data-placement="top"
                                            data-original-title="رفع وثيقة التأمين للمرور / نجم من قبل <br>شركة أمانة للتأمين <br> سريع جدا!<br>الوقت المتوقع لعملية رفع الوثيقة هو 3 دقائق">
                                            <div class="najmtitle">سرعة الربط</div>
                                            <span><img class="mt-2" width="80" height="auto"
                                                    src="//dmul2da2acg0k.cloudfront.net/Resources/images/star4.png?v=17.60"
                                                    alt="" title=""></span>
                                        </div>
                            ...
                            <div class="car-card d-flex flex-row">
                                ...
                                <div class="card-body col-5 col-sm-12">
                                    <div class="titlebox" style="margin-top: -13px;">
                                        ...
                                        <div class="show-all"> <a value="34" class="collapsed tpl"
                                                data-toggle="collapse" data-target="#MoreFeature_34"
                                        ...
                                        <ul class="d-flex">
                                            ...
                                            <li class="m-2">
                                                <a href="javascript:void(0);" data-toggle="tooltip" title=""
                                                    data-placement="top"
                                                    data-original-title="الحد الأقصى لمسؤولية الشركة في الواقعة الواحدة وخلال فترة سريان وثيقة التأمين بالنسبة للأضرار الجسدية (بما في ذلك الديات والمبالغ المقدرة عن الإصابات والمصاريف الطبية) والأضرار المادية معاً لن تتجاوز مبلغاً إجمالياً قدره 1,000 دينار (الف دينار أردني) حداً أقصى لمسئولية الشركة">
                                            ...
                                            <li class="m-2">
                                                <a href="javascript:void(0);" data-toggle="tooltip" title=""
                                                    data-placement="top"
                                                    data-original-title="مسؤولية الطرف الثالث عن الاضرار الجسدية">
                                    ...
                                    <ul class="feature-list">
                                        ...
                                        <li class="clearfix">
                                            ...
                                            <div class="feature-text tpl-feature" id="Feature_34">
                                                الحد الأقصى لمسؤولية الشركة في الواقعة الواحدة وخلال فترة سريان وثيقة
                                                التأمين بالنسبة للأضرار الجسدية (بما في ذلك الديات والمبالغ المقدرة عن
                                                الإصابات والمصاريف الطبية) والأضرار المادية معاً لن تتجاوز مبلغاً إجمالياً
                                                قدره 1,000 دينار (الف دينار أردني) حداً أقصى لمسئولية الشركة
                                            </div>
                                        </li>

                                        <div id="MoreFeature_34" class="in collapse show" aria-expanded="false"
                                            style="">
                                            <li class="clearfix">
                                ...
                                <div class="card-body col-5 col-sm-12" style="border-right: 2px solid #c7c7c7;">
                                    ...
                                    <div class="featuremain-box">
                                        <div class="advance-featurebox" id="additionalFeatureSection595498800">
                                            <input type="hidden" id="TPLadditionValue595498800" value="0"
                                                class="clearable x onX">
                                            <div class="titlebox" style="margin-top: -13px;">
                                            ...
                                            <div class="extension-checkboxes label-feature-tpl"
                                                id="addationalFeatureDivId595498800">
                                            </div>
                                        </div>
                                        <div class="quote-termslink-new">
                                            <a target="_blank"
                                                href="/Common/downloadpdf/dGgbEON1TKZIid2wJrMtMA9a7y261eLn-X1K3UjWLB0iQkJihZbsq8JvjBPRZDHbalc06vPr2V3tG9KD7GfkBg$$">
                                                الشروط و الأحكام
                                            </a>
                                        </div>
                                    </div>
                                        ...
                                        <div class="tpl-bottom-price d-flex justify-content-end p-3">
                                            <div class="tpl-price-box ">
                                                ...
                                                <div class="company-price ">
                                                    <input id="PAMT" name="PAMT" type="hidden" value="1694.39"
                                                        class="clearable x onX">
                                                    <div class="old-price">
                                                        <span id="old-price-value-595498800"></span>
                                                    </div>
                                                    <input type="hidden" value="1694.39"
                                                        id="totalPriceHiddenId595498800" class="clearable x onX">
                                                    <label class="sorting-price"> 200</label>
                                                    <sub>
                                                        د.أ
                                                    </sub>
                                                </div>
