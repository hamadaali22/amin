                        ...
                        <form method="post" class="row">
                            ...
                            <div class="col-lg-6 responsive-column">
                                <div class="input-box">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" type="text" name="sub_insurance_name" placeholder="sub_insurance_name">
                                    </div>
                                </div>
                            </div><!-- end col-lg-6 -->
                            ...
                            <div class="col-lg-6 responsive-column">
                                <div class="input-box">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" type="number" name="insurance_id" placeholder="insurance_id">
                                    </div>
                                </div>
                            </div><!-- end col-lg-6 -->
