                        ...
                        <div class="col-lg-6">
                            <div class="breadcrumb-content">
                                <div class="section-heading">
                                    <h2 class="sec__title font-size-30 text-white">التأمينات</h2>
                                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="form-box">
                               {{-- <div class="form-title-wrap">
                                    <div>
                                        <h3 class="title">قوائم السائقين</h3>
                                    ...
                                    <div class="table-form table-responsive">
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <th scope="col">الإسم الفرعي</th>
                                                <th scope="col">السيارة</th>
                                                <th scope="col">المالك</th>
                                                <th scope="col">الشركة</th>
                                                <th scope="col">تاريخ بدء التأمين</th>
                                                <th scope="col">تاريخ إنتهاء التأمين</th>
                                                <th scope="col">رمز عملية الدفع</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="table-content">
                                                        ...
                                                        <a href="{{ route('orders.edit', 1) }}" class="theme-btn theme-btn-small" data-toggle="tooltip" data-placement="top" title="تعديل"><i class="la la-edit"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                            </tbody>
