                        ...
                        <div class="col-lg-6">
                            <div class="breadcrumb-content">
                                <div class="section-heading">
                                    <h2 class="sec__title font-size-30 text-white">أنواع السيارات</h2>
                                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="form-box">
                                <div class="form-title-wrap">
                                    <div>
                                        <h3 class="title">قوائم السيارات</h3>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="table-content">
                                                        ...
                                                        <a href="{{ route('car_brands.edit', 1) }}" class="theme-btn theme-btn-small" data-toggle="tooltip" data-placement="top" title="تعديل"><i class="la la-edit"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                            </tbody>
