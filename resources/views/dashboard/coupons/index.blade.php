                        ...
                        <div class="col-lg-6">
                            <div class="breadcrumb-content">
                                <div class="section-heading">
                                    <h2 class="sec__title font-size-30 text-white">كوبونات الخصم</h2>
                                </div>
                                ...
                                <div class="form-content">
                                    <div class="table-form table-responsive">
                                        <table class="table">
                                            ...
                                            <tr>
                                                <th scope="col">#</th>
                                                <th scope="col">إسم الكوبون</th>
                                                <th scope="col">رمز الكوبون</th>
                                                <th scope="col">عدد الإستخدامات</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="table-content">
                                                        ...
                                                        <a href="{{ route('coupons.edit', 1) }}" class="theme-btn theme-btn-small" data-toggle="tooltip" data-placement="top" title="تعديل"><i class="la la-edit"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                            </tbody>
