                        ...
                        <div class="col-lg-6">
                            <div class="breadcrumb-content">
                                <div class="section-heading">
                                    <h2 class="sec__title font-size-30 text-white">السائقين</h2>
                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="table-content">
                                                        ...
                                                        <a href="{{ route('drivers.edit', 1) }}" class="theme-btn theme-btn-small" data-toggle="tooltip" data-placement="top" title="تعديل"><i class="la la-edit"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                            </tbody>
